export const CV = {
    hero: {
      ...
      surname: "Boeru",
      city: "📌Madrid / España",
      email: "📨beniboeru702@gmail.com",
      birthDate: "12/02/2002",
      phone: "📲(+40) 767333841",
      image: "https://e.rpp-noticias.io/large/2016/01/25/301630_68611.jpg  ",
      gitHub: "💻https://github.com/DavidBoeru",
      aboutMe: [
        {
    ...
    experience: [
      ...
      },
      {
        ...
        description:
          "Manage the company, which is a multi-billion dollar multinational ",
      },
    ],
    languages: {
      language: "English",
