...
export const CheckCode = () => {
  ...
  //* funcion resendCode confirmation --> con boton con evento onclick(no tiene submit)
  ...
  //! 2) --------- useEffect que nos sirve cuando cambia la res al lanzar el comprobador de erroes
  ...
  useEffect(() => {
   ...
   // gestion del reenvio de codigo de confirmacio
   useEffect(() => {
...
<>
    <div className="form-wrap">
        ...
        <p>Escribe el código enviado a su correo electrónico.</p>
        ...
        <p className="bottom-text">
            <small>
            Si el código no es correcto ❌, su usuario será eliminado de la
            base de datos y deberá registrarse nuevamente.{" "}
            </small>
        </p>
        </form>
    </div>
